...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nPrinting each element in reverse order from linked lise");
		while(it.hasNext()) {
			System.out.print(it.next() + " ");
		}
		...
		System.out.println("After removing first occurrence element: " + ll);
		
		//remove last occurrence of element from linked list
		System.out.println("\nElements in linked list: " + ll);
		ll.removeLastOccurrence("three");
		System.out.println("After removing last occurrence element: " + ll);
